...
function CreateRhombus() : TRhombus;
...
function GetRhombusPerimeter(const R: TRhombus): Real;
...
function CreateRhombus() : TRhombus;
begin
  Write('Enter Rhombus point: ');
  ReadLn(CreateRhombus.A.x, CreateRhombus.A.y);
  Write('Enter diagonals: ');
  ReadLn(CreateRhombus.D1, CreateRhombus.D2);
end;
